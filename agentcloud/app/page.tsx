    ...
    <section className="space-y-5">
      <div className="ac-panel p-6 md:p-7">
        <div className="flex items-center justify-between gap-3">
          <h1 className="text-2xl md:text-3xl font-semibold ac-title">{t("homeTitle")}</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="ac-panel p-5">
          ...
          <div className="text-xl mt-1 font-medium text-[var(--success)]">Ready</div>
          <div className="ac-muted text-sm mt-2">基础框架、主题与路由已就绪。</div>
        </div>
        <div className="ac-panel p-5">
          <div className="text-sm ac-muted">Mode</div>
          <div className="text-xl mt-1 font-medium text-[var(--accent)]">Template A</div>
